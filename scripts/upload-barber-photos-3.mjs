...
const UPLOADS = [
  { file: '09BF856C-B43A-451F-B227-C0B862DC7EB4.PNG', firstName: 'joseph', slug: 'joseph.png',       mime: 'image/png'  },
  { file: 'BC1B8A6C-E70C-4648-8A35-D1D29F9148A1.PNG', firstName: 'wil',    slug: 'wil.png',          mime: 'image/png'  },
  { file: 'C2055F3A-2523-4276-993C-726F2810156D.PNG', firstName: 'elias',  slug: 'elias.png',        mime: 'image/png'  },
  { file: 'IMG_3158 2.jpg',                           firstName: 'tyrik',  slug: 'tyrik.jpg',        mime: 'image/jpeg' },
  { file: 'IMG_9083.PNG',                             firstName: 'josh',   slug: 'josh-wagner.png',  mime: 'image/png'  },
]
...
for (const { file, firstName, slug, mime } of UPLOADS) {
  ...
  const { data: up, error: upErr } = await admin.storage
    .from('barber-photos')
    .upload(slug, data, { contentType: mime, upsert: true })
